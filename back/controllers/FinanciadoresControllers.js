...
const createFinanciadores = async (req, res) => {
    ...
    try {
        ...
        res.status(201).json({ message: 'Datos guardados correctamente', Financiador: newFinanciador });
    } catch (error) {
...
const updateFinanciadores = async (req, res) => {
    ...
    try {
        ...
        if (Financiador) {
            ...
            res.status(200).json({ message: 'Datos actualizados', Entidad });
        } else {
